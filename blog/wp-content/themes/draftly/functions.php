...
function draftly_info_page() {
	...
	<div class="wrap about-wrap draftly-add-css">
		<div>
			<h1>
				<?php echo __('Welcome to Draftly!','draftly'); ?>
			</h1>
			...
			<div class="feature-section three-col">
				...
				<div class="col">
					<div class="widgets-holder-wrap">
						<h3><?php echo __("View our other themes", "draftly"); ?></h3>
						<p><?php echo __("Do you like our concept but feel like the design doesn't fit your need? Then check out our website for more designs.", "draftly"); ?></p>
						<p><a target="blank" href="https://superbthemes.com/wordpress-themes/" class="button button-primary">
							<?php echo __("View All Themes", "draftly"); ?>
						</a></p>
					</div>
				</div>
				<div class="col">
					<div class="widgets-holder-wrap">
						<h3><?php echo __("Premium Edition", "draftly"); ?></h3>
		...
		<table class="wp-list-table widefat">
			<thead>
				<tr>
					<th><strong><?php echo __("Theme Feature", "draftly"); ?></strong></th>
					<th><strong><?php echo __("Basic Version", "draftly"); ?></strong></th>
